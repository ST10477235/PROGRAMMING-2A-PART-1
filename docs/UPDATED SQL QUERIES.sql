...
-- 5. CATEGORY (MaxParticipants entity from ERD) - this stores event categories, distance tiers, fees and capacity limits 
...
VALUES
('Sipho', 'Khumalo', 'sipho.organiser@raceday.co.za', 'AQAAAAEAACcQAAAAEFakeHashedPassword1==', '0821234567', 'Organiser', '2026-01-15 08:00:00'),
('Lerato', 'Mokoena', 'lerato.organiser@raceday.co.za', 'AQAAAAEAACcQAAAAEFakeHashedPassword2==', '0839876543', 'Organiser', '2026-01-20 09:30:00'),
('John', 'Smith', 'john.participant@gmail.com', 'AQAAAAEAACcQAAAAEFakeHashedPassword3==', '0723456789', 'Participant', '2026-02-01 10:15:00'),
('Nomusa', 'Dlamini', 'nomusa.dlamini@gmail.com', 'AQAAAAEAACcQAAAAEFakeHashedPassword4==', '0765432109', 'Participant', '2026-02-05 14:20:00');
...
-- 4. Events
INSERT INTO dbo.EVENT (event_organiserID, name, description, date, location, startTime, routemap, eventType, registrationDeadline)
VALUES
(1, 'Soweto Spring Marathon', 'Annual road running event through historic streets of Soweto.', '2026-08-15', 'Soweto, Johannesburg', '06:00:00', 'https://racedaystorage.blob.core.windows.net/maps/soweto-map.png', 'Marathon', '2026-08-01 23:59:59'),
(1, 'Joburg Fun Walk & Run', 'Family-friendly 5km and 10km event through Zoo Lake.', '2026-11-05', 'Zoo Lake, Johannesburg', '07:30:00', 'https://racedaystorage.blob.core.windows.net/maps/zoolake-map.png', 'Fun Run', '2026-10-25 23:59:59'),
(2, 'Cape Peninsula Cycle Tour', 'Scenic cycling tour around the Cape Peninsula coastline.', '2026-12-01', 'Cape Town, Western Cape', '05:30:00', 'https://racedaystorage.blob.core.windows.net/maps/cape-cycle-map.png', 'Cycling', '2026-11-15 23:59:59');

-- 5. Categories (MaxParticipants)
